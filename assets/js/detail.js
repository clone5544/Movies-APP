...
// Return Only Trailer And Teasers
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function(movie) {
    ...
    document.title = `${title} - Cinematrix`;
    ...
    movieDetail.innerHTML = `
        ...
        <div class="detail-box">
            <div class="detail-content">
                ...
                <div class="meta-list">
                    <div class="meta-item">
                        <img src="star.png" width="20" height="20" alt="rating" />
    ...
    for (const { key, name } of filterVideos(videos)) {
        ...
        videoCard.innerHTML = `<iframe width="550" height="294" src="https://www.youtube.com/embed/${key}?theme=dark&color=white&rel=0" frameborder="0" allowfullscreen="1" title="${name}" class="img-cover" loading="lazy"></iframe>`;
